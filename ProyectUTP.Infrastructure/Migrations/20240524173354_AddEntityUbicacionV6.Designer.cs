...
namespace ProyectUTP.Infrastructure.Migrations
{
    ...
    [Migration("20240524173354_AddEntityUbicacionV6")]
    partial class AddEntityUbicacionV6
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ProyectUTP.Domain.Identity.Entities.Status", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreadoPor = "Sistema",
                            FechaCreacion = new DateTime(2024, 5, 24, 17, 33, 54, 580, DateTimeKind.Utc).AddTicks(9255),
                            Name = "Activo"
                        },
                        new
                        {
                            Id = 2,
                            CreadoPor = "Sistema",
                            FechaCreacion = new DateTime(2024, 5, 24, 17, 33, 54, 580, DateTimeKind.Utc).AddTicks(9266),
                            Name = "Inactivo"
                        },
                        new
                        {
                            Id = 3,
                            CreadoPor = "Sistema",
                            FechaCreacion = new DateTime(2024, 5, 24, 17, 33, 54, 580, DateTimeKind.Utc).AddTicks(9268),
                        ...
                        new
                        {
                            Id = 4,
                            CreadoPor = "Sistema",
                            FechaCreacion = new DateTime(2024, 5, 24, 17, 33, 54, 580, DateTimeKind.Utc).AddTicks(9269),
                            Name = "Aceptado"
                        },
                        new
                        {
                            Id = 5,
                            CreadoPor = "Sistema",
                            FechaCreacion = new DateTime(2024, 5, 24, 17, 33, 54, 580, DateTimeKind.Utc).AddTicks(9270),
                            Name = "Rechazado"
                        },
                        new
                        {
                            Id = 6,
                            CreadoPor = "Sistema",
                            FechaCreacion = new DateTime(2024, 5, 24, 17, 33, 54, 580, DateTimeKind.Utc).AddTicks(9271),
                            Name = "Revisado"
                        },
                        new
                        {
                            Id = 7,
                            CreadoPor = "Sistema",
                            FechaCreacion = new DateTime(2024, 5, 24, 17, 33, 54, 580, DateTimeKind.Utc).AddTicks(9273),
                            Name = "En revisión"
                        },
                        new
                        {
                            Id = 8,
                            CreadoPor = "Sistema",
                            FechaCreacion = new DateTime(2024, 5, 24, 17, 33, 54, 580, DateTimeKind.Utc).AddTicks(9274),
                        ...
                        new
                        {
                            Id = 9,
                            CreadoPor = "Sistema",
                            FechaCreacion = new DateTime(2024, 5, 24, 17, 33, 54, 580, DateTimeKind.Utc).AddTicks(9275),
                            Name = "Suspendido"
                        });
                });
