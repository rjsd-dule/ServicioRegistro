...
namespace ProyectUTP.Infrastructure.Migrations
{
    ...
    [Migration("20240523065030_UpdateEtityUbicacionV4")]
    partial class UpdateEtityUbicacionV4
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ProyectUTP.Domain.Identity.Entities.Status", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreadoPor = "Sistema",
                            FechaCreacion = new DateTime(2024, 5, 23, 6, 50, 30, 439, DateTimeKind.Utc).AddTicks(7984),
                            Name = "Activo"
                        },
                        new
                        {
                            Id = 2,
                            CreadoPor = "Sistema",
                            FechaCreacion = new DateTime(2024, 5, 23, 6, 50, 30, 439, DateTimeKind.Utc).AddTicks(7992),
                            Name = "Inactivo"
                        },
                        new
                        {
                            Id = 3,
                            CreadoPor = "Sistema",
                            FechaCreacion = new DateTime(2024, 5, 23, 6, 50, 30, 439, DateTimeKind.Utc).AddTicks(7994),
                        ...
                        new
                        {
                            Id = 4,
                            CreadoPor = "Sistema",
                            FechaCreacion = new DateTime(2024, 5, 23, 6, 50, 30, 439, DateTimeKind.Utc).AddTicks(7995),
                            Name = "Aceptado"
                        },
                        new
                        {
                            Id = 5,
                            CreadoPor = "Sistema",
                            FechaCreacion = new DateTime(2024, 5, 23, 6, 50, 30, 439, DateTimeKind.Utc).AddTicks(7997),
                            Name = "Rechazado"
                        },
                        new
                        {
                            Id = 6,
                            CreadoPor = "Sistema",
                            FechaCreacion = new DateTime(2024, 5, 23, 6, 50, 30, 439, DateTimeKind.Utc).AddTicks(7998),
                            Name = "Revisado"
                        },
                        new
                        {
                            Id = 7,
                            CreadoPor = "Sistema",
                            FechaCreacion = new DateTime(2024, 5, 23, 6, 50, 30, 439, DateTimeKind.Utc).AddTicks(8000),
                            Name = "En revisión"
                        },
                        new
                        {
                            Id = 8,
                            CreadoPor = "Sistema",
                            FechaCreacion = new DateTime(2024, 5, 23, 6, 50, 30, 439, DateTimeKind.Utc).AddTicks(8001),
                        ...
                        new
                        {
                            Id = 9,
                            CreadoPor = "Sistema",
                            FechaCreacion = new DateTime(2024, 5, 23, 6, 50, 30, 439, DateTimeKind.Utc).AddTicks(8007),
                            Name = "Suspendido"
                        });
                });
